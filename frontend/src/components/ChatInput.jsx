    ...
    <form onSubmit={handleSubmit} className="p-3 md:p-4 bg-white dark:bg-kit-dark-bg transition-colors duration-300">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-2 md:gap-3 bg-white dark:bg-kit-dark-bg-light rounded-full px-3 md:px-4 py-1.5 md:py-2 shadow-sm border border-gray-200 dark:border-kit-dark-bg-lighter transition-colors duration-300">
          ...
          <button
            type="button"
            className="hidden sm:flex shrink-0 w-10 h-10 items-center justify-center text-gray-600 dark:text-kit-dark-text-muted hover:text-white hover:bg-kit-red dark:hover:bg-kit-red rounded-full transition-all duration-300"
          >
          ...
          <button
            type="button"
            className="hidden sm:flex shrink-0 w-10 h-10 items-center justify-center text-gray-600 dark:text-kit-dark-text-muted hover:text-white hover:bg-yellow-500 dark:hover:bg-yellow-600 rounded-full transition-all duration-300"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
